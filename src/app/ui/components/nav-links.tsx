      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              `flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 hover:bg-purple-200 transition-all text-sm font-medium  md:flex-none md:justify-start md:p-2 md:px-3`,
              {
